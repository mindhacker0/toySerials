...
pub fn setup(
    ...
    commands.spawn(MaterialMesh2dBundle {
        ...
        material: materials.add(Color::srgb(1.5, 0.0, 7.5)),
...
#[wasm_bindgen]
pub fn startup_web() {
    let base_url = get_assets_path();
    let canvas_id = get_canvas_id();
    // bevy::log::info!("baseUrl: {}", base_url);
    App::new()
    .add_plugins(
        DefaultPlugins
            .set(WindowPlugin {
            ...
            .set(AssetPlugin {
                file_path: base_url.clone(),
                processed_file_path: base_url,
                ..default()
            }),
    )
